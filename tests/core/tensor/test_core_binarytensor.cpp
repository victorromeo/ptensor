...
PTENSOR_TEST(core, resizeBinaryTensor, "Test resize tensor")
PTENSOR_TEST(core, reshapeBinaryTensor, "Test reshape tensor")
PTENSOR_TEST(core, permuteBinaryTensor, "Test permute tensor")
