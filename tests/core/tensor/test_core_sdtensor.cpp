...
PTENSOR_TEST(core, readSDTensor, "Test sdtensor read interface")
PTENSOR_TEST(core, writeSDTensor, "Test sdtensor write interface")
PTENSOR_TEST(core, matmulSDtensor, "Test sdtensor matrix mul test")
