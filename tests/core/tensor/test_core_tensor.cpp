...
PTENSOR_TEST(core, resizeTensor, "Test resize tensor")
PTENSOR_TEST(core, reshapeTensor, "Test reshape tensor")
PTENSOR_TEST(core, permuteTensor, "Test permute tensor")
