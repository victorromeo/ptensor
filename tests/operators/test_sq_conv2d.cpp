...
TEST(Conv2D, random_gen_conv2d__0_f) {
  ...
  pTensor::ReferenceOperators::Conv2dOperator<float> convOp({1,1,1,1}, VALID);
  convOp
  .set_inputs({ 
    { pTensor::ReferenceOperators::Conv2dOperator<float>::in, in },
    { pTensor::ReferenceOperators::Conv2dOperator<float>::filter, w },
    { pTensor::ReferenceOperators::Conv2dOperator<float>::bias, b }
  }).set_outputs({ 
    { pTensor::ReferenceOperators::Conv2dOperator<float>::out, out }
  }).eval();
...
TEST(Conv2D, random_gen_conv2d__0_q) {
  ...
  pTensor::ReferenceOperators::Conv2dOperator<int8_t> convOp({1,1}, VALID);
  convOp
  .set_inputs({ 
    { pTensor::ReferenceOperators::Conv2dOperator<int8_t>::in, in },
    { pTensor::ReferenceOperators::Conv2dOperator<int8_t>::filter, w },
    { pTensor::ReferenceOperators::Conv2dOperator<int8_t>::bias, b }
  }).set_outputs({ 
    { pTensor::ReferenceOperators::Conv2dOperator<int8_t>::out, out }
  }).eval();
