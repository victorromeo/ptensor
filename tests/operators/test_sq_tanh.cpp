...
TEST(QuantTanhTest, sq_tanh_0) {
  ...
  pTensor::ReferenceOperators::TanhOperator<int8_t,int8_t> tanh_op;
  tanh_op
  .set_inputs({ 
    { pTensor::ReferenceOperators::TanhOperator<int8_t,int8_t>::act_in, input }
  }).set_outputs({ 
    { pTensor::ReferenceOperators::TanhOperator<int8_t,int8_t>::act_out, output }
  }).eval();
