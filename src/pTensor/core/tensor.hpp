#ifndef PTENSOR_TENSOR_H
#define PTENSOR_TENSOR_H
...
// template <typename Allocator=ptensor::DefaultTensorMetaDataAllocator>
//
...
struct SimpleNamedTensor {
 public:
  SimpleNamedTensor();
  SimpleNamedTensor(const pTensor::string& name, Tensor& tensor);
  Tensor& tensor();
 public:
  const pTensor::string* name;  // Fixed
 private:
